...
public class Loader {
    ...
    public void refresh() {
        tasksClient.getAllTasks(filterTaskFormWidget.getExecutorId()
...
//                table.setRowStyles();
    ...
    public void getTaskInfo(TaskDto taskDto){
        tasksClient.getTask(taskDto.getId().toString(), new MethodCallback<TaskDto>() {
            @Override
            public void onFailure(Method method, Throwable throwable) {
                GWT.log(throwable.toString());
                GWT.log(throwable.getMessage());
    ...
    public void getExecutors(ListBox executor, String selectVal) {
        userClient.getUsers(2L, new MethodCallback<List<UserDto>>() {
            @Override
            public void onFailure(Method method, Throwable throwable) {
                GWT.log(throwable.toString());
                GWT.log(throwable.getMessage());
    ...
    public void getOwner(ListBox owner, String selectVal) {
        userClient.getUsers(1L, new MethodCallback<List<UserDto>>() {
            @Override
            public void onFailure(Method method, Throwable throwable) {
                GWT.log(throwable.toString());
                GWT.log(throwable.getMessage());
    ...
    public void getStatus(ListBox status, String selectVal) {
        statusClient.getStatus(new MethodCallback<List<StatusDto>>() {
            @Override
            public void onFailure(Method method, Throwable throwable) {
                GWT.log(throwable.toString());
                GWT.log(throwable.getMessage());
